        ...
        {error ? (
          ...
          <div className="text-center space-y-2 max-w-md">
            ...
            <p className="text-xs text-muted-foreground">
              The scan read every path it visited. Nothing on this target was skipped for permissions.
            </p>
          </div>
        )}
      </div>
  ...
  return (
    <div className="flex flex-1 flex-col h-full min-h-0">
      ...
      <div className="flex items-center gap-4 border-b border-border px-4 py-2.5">
        ...
        <Button variant="outline" size="sm" onClick={() => runExport('all')} disabled={exporting}>
          <Download className="size-3 mr-1" />
          All
        </Button>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={cn(
            'w-[220px] shrink-0 border-r border-border overflow-auto p-3 space-y-3',
            !filtersOpen && 'hidden',
          )}
        >
